...
class Snake: SKShapeNode {
    ...
    // скорость змейки
    static let moveSpeed1 = 125.0
    // скорость перемещения
    var moveSpeed = Snake.moveSpeed1
    ...
    func move() {
        ...
        if moveSpeed == 0 { return } // если змейка уперлась в стену, то должно остановиться тело
